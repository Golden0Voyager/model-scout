...
STATIC_MODELS: List[ModelConfig] = [
    ...
    ModelConfig(
        ...
        description="ZhipuAI GLM-4.7 Flash. Latest free flash model.",
        description_cn="智谱 GLM-4.7 Flash，最新免费 Flash 模型。",
        capabilities=["chat"],
        is_free=True,
    ),
    ...
    ModelConfig(
        ...
        description="Moonshot V1 8K. Entry-level model suitable for short-context tasks.",
        description_cn="Moonshot V1 8K，入门级模型，适合短上下文任务。",
        capabilities=["chat"],
    ),
    ModelConfig(
        id="moonshot-v1-32k",
        ...
        description="Moonshot V1 32K. Mid-range model with moderate context window.",
        description_cn="Moonshot V1 32K，中端模型，拥有适中的上下文窗口。",
        capabilities=["chat"],
    ),
    ModelConfig(
        id="moonshot-v1-128k",
        ...
        description="Moonshot V1 128K. Long-context model for extensive document processing.",
        description_cn="Moonshot V1 128K，长上下文模型，适合大规模文档处理。",
        capabilities=["chat", "long_context"],
    ),
    ModelConfig(
        id="moonshot-v1-auto",
        ...
        context_length=131072,
        max_output_tokens=131072,
        description="Moonshot V1 Auto. Automatically selects optimal context length for the input.",
        description_cn="Moonshot V1 Auto，根据输入自动选择最佳上下文长度。",
        capabilities=["chat", "long_context"],
    ),
    ModelConfig(
        ...
        context_length=8192,
        max_output_tokens=8192,
        description="Moonshot V1 8K Vision Preview. Entry-level vision model for image understanding tasks.",
        description_cn="Moonshot V1 8K Vision 预览版，入门级视觉模型，支持图像理解任务。",
    ...
    ModelConfig(
        ...
        context_length=32768,
        max_output_tokens=32768,
        description="Moonshot V1 32K Vision Preview. Mid-range vision model for image and text tasks.",
        description_cn="Moonshot V1 32K Vision 预览版，中端视觉模型，支持图像和文本任务。",
        capabilities=["chat", "vision"],
    ),
    ModelConfig(
        ...
        context_length=131072,
        max_output_tokens=131072,
        description="Moonshot V1 128K Vision Preview. Long-context vision model for extensive multimodal tasks.",
        description_cn="Moonshot V1 128K Vision 预览版，长上下文视觉模型，适合大规模多模态任务。",
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2.5 Pro (Token Plan). Deep thinking, function calling, structured output, web search.",
        description_cn="MiMo V2.5 Pro（Token Plan），深度思考、函数调用、结构化输出、联网搜索。",
        capabilities=["chat", "reasoning", "coding", "function_calling"],
        pricing_input_per_1m=3.0,
        pricing_output_per_1m=6.0,
        pricing_note="Cache Hit ¥0.025",
    ),
    ModelConfig(
        id="mimo-v2.5",
        name="MiMo V2.5",
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2.5 (Token Plan). Multimodal understanding, deep thinking, function calling, web search.",
        description_cn="MiMo V2.5（Token Plan），多模态理解、深度思考、函数调用、联网搜索。",
        capabilities=["chat", "reasoning", "vision", "function_calling"],
        pricing_input_per_1m=1.0,
        pricing_output_per_1m=2.0,
        pricing_note="Cache Hit ¥0.02",
    ),
    ModelConfig(
        id="mimo-v2-pro",
        name="MiMo V2 Pro",
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2 Pro (Token Plan). Deep thinking, function calling, structured output, web search.",
        description_cn="MiMo V2 Pro（Token Plan），深度思考、函数调用、结构化输出、联网搜索。",
        capabilities=["chat", "reasoning", "coding", "function_calling"],
        pricing_input_per_1m=14.0,
        pricing_output_per_1m=21.0,
        pricing_note="≤256K; 256K-1M: ¥42/¥42; Cache Hit ¥1.4",
    ),
    ModelConfig(
        id="mimo-v2-omni",
        name="MiMo V2 Omni",
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="MiMo V2 Omni (Token Plan). Multimodal understanding, deep thinking, function calling, web search.",
        description_cn="MiMo V2 Omni（Token Plan），多模态理解、深度思考、函数调用、联网搜索。",
        capabilities=["chat", "reasoning", "vision", "function_calling"],
        pricing_input_per_1m=0.56,
        pricing_output_per_1m=2.80,
    ),
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2.5 Pro (Pay-as-you-go). Deep thinking, function calling, structured output, web search.",
        description_cn="MiMo V2.5 Pro（按量付费），深度思考、函数调用、结构化输出、联网搜索。",
        capabilities=["chat", "reasoning", "coding", "function_calling"],
        pricing_input_per_1m=3.0,
        pricing_output_per_1m=6.0,
        pricing_note="Cache Hit ¥0.025",
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2.5 (Pay-as-you-go). Multimodal understanding, deep thinking, function calling, web search.",
        description_cn="MiMo V2.5（按量付费），多模态理解、深度思考、函数调用、联网搜索。",
        capabilities=["chat", "reasoning", "vision", "function_calling"],
        pricing_input_per_1m=1.0,
        pricing_output_per_1m=2.0,
        pricing_note="Cache Hit ¥0.02",
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=128000,
        description="MiMo V2 Pro (Pay-as-you-go). Deep thinking, function calling, structured output, web search.",
        description_cn="MiMo V2 Pro（按量付费），深度思考、函数调用、结构化输出、联网搜索。",
        capabilities=["chat", "reasoning", "coding", "function_calling"],
        pricing_input_per_1m=14.0,
        pricing_output_per_1m=21.0,
        pricing_note="≤256K; 256K-1M: ¥42/¥42; Cache Hit ¥1.4",
    ...
    ModelConfig(
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="MiMo V2 Omni (Pay-as-you-go). Multimodal understanding, deep thinking, function calling, web search.",
        description_cn="MiMo V2 Omni（按量付费），多模态理解、深度思考、函数调用、联网搜索。",
        capabilities=["chat", "reasoning", "vision", "function_calling"],
        pricing_input_per_1m=0.56,
        pricing_output_per_1m=2.80,
    ),
    ModelConfig(
        ...
        description="MiMo V2 Flash (Pay-as-you-go). Lightweight, fast inference with deep thinking support.",
        description_cn="MiMo V2 Flash（按量付费），轻量快速推理，支持深度思考。",
        capabilities=["chat", "reasoning", "function_calling"],
        pricing_input_per_1m=0.07,
        pricing_output_per_1m=0.70,
    ),
    ...
    ModelConfig(
        ...
        description="Google Gemini 3.1 Pro. Flagship model with 2M+ context, native multimodal, advanced reasoning and tool calling.",
        description_cn="Google Gemini 3.1 Pro，旗舰模型，200万+上下文，原生多模态，高级推理和工具调用。",
        capabilities=["chat", "vision", "reasoning", "function_calling", "long_context"],
        pricing_input_per_1m=1.25,
        pricing_output_per_1m=5.0,
        pricing_currency="USD",
        pricing_note="Free tier: 15 RPM (Flash only)",
    ),
    ModelConfig(
        ...
        provider="gemini",
        context_length=1000000,
        description="Google Gemini 3.1 Flash Lite. Ultra-fast lightweight model, 30% lower latency than previous gen.",
        description_cn="Google Gemini 3.1 Flash Lite，超快轻量模型，延迟比前代降低 30%。",
        capabilities=["chat", "function_calling"],
        pricing_input_per_1m=0.01,
        pricing_output_per_1m=0.04,
        pricing_currency="USD",
        is_free=True,
        pricing_note="Free tier: 15 RPM",
    ),
    ModelConfig(
        id="gemini-2.5-pro",
        name="Gemini 2.5 Pro",
        ...
        description="Google Gemini 2.5 Pro. Strong reasoning, multimodal, 1M context.",
        description_cn="Google Gemini 2.5 Pro，强推理、多模态、100万上下文。",
        capabilities=["chat", "vision", "reasoning", "coding", "function_calling", "long_context"],
        pricing_input_per_1m=1.25,
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=65536,
        description="Google Gemini 2.5 Flash. Fast, cost-effective, 1M context.",
        description_cn="Google Gemini 2.5 Flash，快速、高性价比、100万上下文。",
        capabilities=["chat", "vision", "reasoning", "coding", "function_calling", "long_context"],
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=65536,
        description="Google Gemini 2.5 Flash Lite. Ultra-lightweight, lowest cost.",
        description_cn="Google Gemini 2.5 Flash Lite，超轻量、最低成本。",
    ...
    ModelConfig(
        ...
        context_length=1000000,
        max_output_tokens=8192,
        description="Google Gemini 2.0 Flash. Previous gen fast model.",
        description_cn="Google Gemini 2.0 Flash，上一代快速模型。",
        capabilities=["chat", "vision", "function_calling", "long_context"],
