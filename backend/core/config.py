...
STATIC_MODELS: List[ModelConfig] = [
    ...
    ModelConfig(
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="Moonshot Kimi K2 Turbo preview. Optimized for faster inference with the K2 series.",
        description_cn="Moonshot Kimi K2 Turbo 预览版，针对 K2 系列推理速度优化。",
        capabilities=["chat", "long_context"],
    ),
    ModelConfig(
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="Moonshot Kimi K2 preview dated 0905. Experimental variant in the K2 family.",
        description_cn="Moonshot Kimi K2 0905 预览版，K2 家族的实验性变体。",
        capabilities=["chat", "long_context"],
    ),
    ModelConfig(
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="Moonshot Kimi K2 preview dated 0711. Earlier experimental variant in the K2 family.",
        description_cn="Moonshot Kimi K2 0711 预览版，K2 家族的早期实验性变体。",
        capabilities=["chat", "long_context"],
    ),
    ModelConfig(
        id="kimi-k2-thinking",
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="Moonshot Kimi K2 Thinking. Reasoning-enabled model with extended thought chains.",
        description_cn="Moonshot Kimi K2 Thinking，支持扩展思维链的推理模型。",
    ...
    ModelConfig(
        ...
        context_length=256000,
        max_output_tokens=128000,
        description="Moonshot Kimi K2 Thinking Turbo. Faster reasoning variant of the K2 Thinking model.",
        description_cn="Moonshot Kimi K2 Thinking Turbo，K2 Thinking 的快速推理变体。",
        capabilities=["chat", "reasoning", "long_context"],
    ),
    ModelConfig(
        id="moonshot-v1-8k",
